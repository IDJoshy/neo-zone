    ...
    return (
        <svg {...props} viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
            <defs>
                ...
                <linearGradient id="instagram-normal" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: "#e1faf9", stopOpacity: 1 }} />
                    <stop offset="25%" style={{ stopColor: "#e1faf9", stopOpacity: 1 }} />
                    <stop offset="50%" style={{ stopColor: "#e1faf9", stopOpacity: 1 }} />
                    <stop offset="75%" style={{ stopColor: "#e1faf9", stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: "#e1faf9", stopOpacity: 1 }} />
                </linearGradient>
            </defs>
            <path
